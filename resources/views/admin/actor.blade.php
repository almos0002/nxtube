                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex space-x-4 text-sm">
                            <span class="text-neutral-400">
                                <i class="fas fa-video mr-1"></i> 48
                            </span>
                            <span class="text-neutral-400">
            ...
            <div class="bg-neutral-700/30 rounded-xl overflow-hidden">
                ...
                <div class="p-4">
                    <div class="flex items-center justify-between">
                        <div class="flex space-x-4 text-sm">
                            <span class="text-neutral-400">
                                <i class="fas fa-video mr-1"></i> 36
                            </span>
                            <span class="text-neutral-400">
                                <i class="fas fa-eye mr-1"></i> 892K
                            </span>
                        </div>
            ...
            <div class="bg-neutral-700/30 rounded-xl overflow-hidden">
                ...
                <div class="p-4">
                    <div class="flex items-center justify-between">
                        <div class="flex space-x-4 text-sm">
                            <span class="text-neutral-400">
                                <i class="fas fa-video mr-1"></i> 92
                            </span>
                            <span class="text-neutral-400">
                                <i class="fas fa-eye mr-1"></i> 2.1M
                            </span>
                        </div>
