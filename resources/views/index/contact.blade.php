...
@section('meta_description',
    ...
    experience for our users. Our contact page is where you can reach out to us with any questions, feedback, or inquiries
    you may have.')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                <div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start space-x-4">
                            <div
                                class="w-10 h-10 rounded-full bg-red-500/10 flex items-center justify-center flex-shrink-0">
                ...
                <div class="bg-neutral-800/30 p-6 rounded-xl">
                    ...
                    <form class="space-y-4">
                        <div>
                            ...
                            <input type="text"
                                class="w-full px-4 py-2 rounded-lg bg-neutral-800 border border-neutral-700 focus:border-red-500 focus:outline-none transition-colors"
            ...
            <section>
                ...
                <div class="space-y-4">
                    <div class="bg-neutral-800/30 p-6 rounded-xl">
                        ...
                        <p class="text-neutral-400">You can report technical issues through our support portal or by
                            emailing support@videoflex.com with detailed information about the problem you're experiencing.
                        </p>
                    </div>
                    <div class="bg-neutral-800/30 p-6 rounded-xl">
                        <h3 class="font-semibold mb-2">What are your business hours?</h3>
                        <p class="text-neutral-400">Our support team is available Monday through Friday, 9:00 AM to 6:00 PM
                            EST. For urgent matters, we also provide 24/7 emergency support.</p>
                    </div>
                    <div class="bg-neutral-800/30 p-6 rounded-xl">
                        <h3 class="font-semibold mb-2">How can I become a content creator?</h3>
                        <p class="text-neutral-400">To become a content creator, sign up for an account and visit your
                            profile settings. Click on "Become a Creator" and follow the verification process.</p>
                    </div>
                </div>
            </section>
        </div>
