...
@section('content')
    ...
    <section class="relative">
        ...
        <div
            class="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-neutral-900 via-neutral-900/80 to-transparent">
            <div class="flex items-center space-x-6">
                <img src="{{ asset('storage/' . ($channel->profile_image ?? 'channels/default.jpg')) }}"
                    class="w-32 h-32 rounded-full border-4 border-neutral-100 shadow-xl" alt="{{ $channel->channel_name }}">
                <div class="flex-1">
