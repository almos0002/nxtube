...
@section('meta_description',
    'At VideoFlex, we take your privacy seriously. This Privacy Policy explains how we collect,
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <section class="mb-12">
                <p class="text-neutral-300 leading-relaxed mb-6">
                    At VideoFlex, we take your privacy seriously. This Privacy Policy explains how we collect, use,
                    disclose, and safeguard your information when you use our video streaming platform.
                </p>
            </section>
            ...
            <div class="space-y-12">
                ...
                <section>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-neutral-800/30 rounded-xl p-6">
                            ...
                            <p class="text-neutral-300">We use your information to improve our services, customize content
                                recommendations, and enhance your viewing experience.</p>
                        </div>
                        <div class="bg-neutral-800/30 rounded-xl p-6">
                            <div class="flex items-center mb-4">
                            ...
                            <p class="text-neutral-300">Your information helps us detect and prevent fraud, abuse, and
                                security incidents on our platform.</p>
                        </div>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div class="bg-neutral-800/30 rounded-xl p-6">
                        <p class="text-neutral-300 mb-4">We implement appropriate technical and organizational measures to
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-neutral-300">You can access and update your personal information through
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-neutral-300">You can request a copy of your data in a structured,
                                        commonly used format.</p>
                                </div>
                            </div>
                            <div class="flex items-start space-x-4">
                                <i class="fas fa-check-circle text-red-500 mt-1"></i>
                                <div>
                                    ...
                                    <p class="text-neutral-300">You can request the deletion of your account and associated
                                        data.</p>
                                </div>
                            </div>
                        </div>
                ...
                <section>
                    ...
                    <div class="bg-neutral-800/30 rounded-xl p-6">
                        <p class="text-neutral-300 mb-4">If you have any questions about this Privacy Policy, please contact
                            us:</p>
                        <div class="space-y-2">
                            <p class="text-neutral-300"><span class="font-semibold">Email:</span> privacy@videoflex.com</p>
                            <p class="text-neutral-300"><span class="font-semibold">Address:</span> 123 Tech Street, San
