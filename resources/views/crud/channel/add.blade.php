...
<div class="ml-64 p-8">
    <header class="bg-neutral-800 shadow-sm rounded-xl p-4 mb-8 flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-bold text-neutral-100">Add New Channel</h2>
            <p class="text-neutral-400">Create and customize your channel</p>
        </div>
    ...
    <form id="channelForm" class="w-full space-y-6" action="{{ route('store-channel') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-2 gap-6">
            ...
            <div class="bg-neutral-800 rounded-xl p-6">
                ...
                <div class="space-y-3">
                    <input type="radio" name="visibility" value="active" class="hidden" id="visibilityActive" checked>
                    <input type="radio" name="visibility" value="inactive" class="hidden" id="visibilityInactive">
